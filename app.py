...
# =================================================
st.set_page_config(
    page_title="FAST 6th Grade Math Arena 2025-2026",
    page_icon="➗",
    layout="wide"
)
st.title("FAST 6th Grade Math Arena ➗")
...
# =================================================
DOMAINS = [
    "1. Integers: positive and negative numbers, number lines, comparing integers",
    "2. Absolute Value: distance from zero in real-world contexts",
    "3. Rational Numbers: ordering and comparing fractions, decimals, and integers",
    "4. Operations with Decimals: add, subtract, multiply, and divide multi-digit decimals",
    "5. Operations with Fractions and Mixed Numbers: add, subtract, multiply, and divide positive fractions and mixed numbers",
    "6. Operations with Integers: add, subtract, multiply, and divide positive and negative integers",
    "7. Ratios, Rates, and Percent: ratios, unit rates, percent problems",
    "8. Expressions and Order of Operations",
    "9. One-Step Equations and Inequalities",
    "10. Coordinate Plane: graphing in all four quadrants",
    "11. Area of Triangles and Quadrilaterals",
    "12. Volume and Surface Area of Right Rectangular Prisms",
    "13. Statistical Questions, Mean, Median, Mode, Range, Box Plots, and Histograms",
]
...
FALLBACK_QUESTIONS = [
    {
        ...
        "D": "-12",
        "correct": "B",
        "explanation": "On a number line, numbers farther to the right are greater. -3 is greater than -8, -10, and -12."
    },
    {
        "question": "The absolute value of -7 is 7.",
        "A": "True",
        "B": "False",
        "C": "Not used",
        "D": "Not used",
        "correct": "A",
        "explanation": "Absolute value is the distance from zero, so |-7| = 7."
    },
    {
        "question": "Put these values in order from least to greatest: -2, 0.5, 1/4, 3.",
        "A": "-2, 1/4, 0.5, 3",
        "B": "1/4, -2, 0.5, 3",
        "C": "-2, 0.5, 1/4, 3",
        "D": "3, 0.5, 1/4, -2",
        "correct": "A",
        "explanation": "Convert when helpful: 1/4 = 0.25, so least to greatest is -2, 0.25, 0.5, 3."
    },
]
...
def clean_event_title(title: str) -> str:
    ...
    if lowered.startswith("[class]"):
        cleaned = raw[7:].strip()
        return cleaned or "FAST Math Arena Event"
    ...
    return raw or "FAST Math Arena Event"
...
def fetch_questions_from_gemini(topic: str, difficulty: str, count: int):
    prompt = f"""
You are a FAST 6th Grade Math exam writer.
...
CONTENT RULES:
- Focus strictly on this FAST 6th Grade Math domain.
- Match Florida FAST 6th Grade Math style.
- Cover procedural fluency, conceptual understanding, and application.
- Use realistic math vocabulary and grade-appropriate numbers.
- Include topics such as integers, absolute value, rational numbers, decimal operations, fraction operations, integer operations, ratios, rates, percent, expressions, order of operations, one-step equations and inequalities, coordinate plane, area, volume, surface area, statistical questions, mean, median, mode, range, box plots, and histograms.
- Use realistic distractors based on common student mistakes.
- Use backticks around expressions when useful.
...
- Example style:
  QUESTION: Put the following numbers in order from least to greatest...
  A) ...
  B) ...
  C) ...
  D) ...
...
if st.session_state.is_teacher:
    ...
    st.caption("Tip: Start the title with [CLASS] to create a class event. Example: [CLASS] FAST Math Arena Event")

    with st.form("teacher_create_event_form"):
        ev1, ev2 = st.columns(2)

        with ev1:
            new_event_title = st.text_input("Event Title", value="FAST Math Arena Event")
